...
### REGISTER ---
def register():
    bpy.types.VIEW3D_HT_header.append(viewport_popover_draw)
    bpy.utils.register_class(FONTSELECTOR_PT_viewport_popover)
    bpy.utils.register_class(FONTSELECTOR_PT_properties_panel)
    
    bpy.types.SEQUENCER_HT_header.append(sequencer_popover_draw)
...
def unregister():
    ...
    bpy.types.VIEW3D_HT_header.remove(viewport_popover_draw)
    bpy.utils.unregister_class(FONTSELECTOR_PT_properties_panel)
    
    bpy.types.SEQUENCER_HT_header.remove(sequencer_popover_draw)
